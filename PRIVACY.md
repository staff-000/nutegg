# Privacy Policy for NutEgg

**Last updated:** September 6, 2026

NutEgg ("we", "our", or "the extension") is a privacy-first, local-first browser extension and companion Obsidian plugin designed to help users capture web content and curate personal knowledge.
...
* Please consult the privacy policy of your selected AI provider for details on how they handle API requests. (Most major providers do not train models on API inputs by default).
...
Because NutEgg stores all captured data and settings locally on your computer (inside Chrome's local storage and your local Obsidian vault):
