...
(0, import_node_test.describe)("PROMPTS", () => {
  ...
  (0, import_node_test.it)("content analysis templates instruct mind map generation up to 3 levels deep", () => {
    import_strict.default.ok(PROMPTS.contentTaskDefault.includes("Mind Map"));
    import_strict.default.ok(PROMPTS.contentTaskDefault.includes("up to 3 levels deep"));
    import_strict.default.ok(PROMPTS.contentAnalysis.includes('"mindMap"'));
    import_strict.default.ok(PROMPTS.contentAnalysis.includes("up to 3 levels deep total"));
    import_strict.default.ok(PROMPTS.aggregateContent.includes('"mindMap"'));
    import_strict.default.ok(PROMPTS.aggregateContent.includes("synthesized concept tree for the entire work, up to 3 levels deep"));
  });
});
